                    ...
                    <section id="content-section-3">
                        <div class="greennature-parallax-wrapper greennature-background-image gdlr-show-all no-skin" id="greennature-parallax-wrapper-1" data-bgspeed="0.11" style="background:#dddddd;">
                            <div class="container">
                                ...
                                <div id="empresas" class="empresas" style="display: flex;
    flex-direction: column;
    align-items: center;">
                                <img src="images/logo_shopping.png" alt="">
                                <h4>Shopping Estação</h4>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
                ...
                <div class="footer-column three columns" id="footer-widget-1">
                    <div id="text-5" class="widget widget_text greennature-item greennature-widget">
                        <div class="textwidget">
                            <p><img src="images/logo.png" style="width: 50px;" alt="" /></p>
                        </div>
                    </div>
                </div>
                <div class="footer-column three columns" id="footer-widget-2">
                    <div id="text-9" class="widget widget_text greennature-item greennature-widget">
                        ...
                        <div class="clear"></div>
                            ...
                            <i class="greennature-icon fa fa-phone" style="vertical-align: middle; color: #fff; font-size: 16px; "></i> <?= $telefone ?>

                            <span class="clear"></span><span class="greennature-space" style="margin-top: 10px; display: block;"></span>

                            <span class="clear"></span><span class="greennature-space" style="margin-top: 10px; display: block;"></span>

                            <i class="greennature-icon fa fa-envelope-o" style="vertical-align: middle; color: #fff; font-size: 16px; "></i> <?= $email ?></div>
                    </div>
                    <div>
                        <h6 style="color: #dddddd;">APOIO:</h6 >
                        <div class="apio_empresas">
                            <img src="images/logo_sebrae.png" style="width: 80px; margin:5px;" alt="">
                            <img src="images/logo_fecomercio.png" style="width: 80px; margin:5px;" alt="">
                            <img src="images/logo_sw.png" style="width: 150px; margin:5px; " alt="">
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
